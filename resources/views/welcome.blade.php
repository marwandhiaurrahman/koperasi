...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('vendor/adminlte/dist/img/smk5kuningan500x500.png') }}" rel="icon">
        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <ul>
              ...
              <li><a href="#">Drop Down 4</a></li>
                    ...
                    @auth
                        <li><a class="getstarted scrollto" href="{{ route('dashboard') }}" data-toggle="tooltip"
                                title="Dashboard">{{ Auth::user()->name }}</a></li>
                    @endauth
                    @guest
                        <li><a class="getstarted scrollto" href="{{ route('login') }}" data-toggle="tooltip"
